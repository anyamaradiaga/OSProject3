/**
* COSC 3250 - Project 4
* Test cases for spinlock and its implementation
...
void testcases(void)
{
    ...
    case '4':
		...
		unparkcore(1, (void *)lock_acquire(testlock), testlock);
    ...
    case '5':
		...
		unparkcore(1, (void *)lock_acquire(testlock), testlock);
        unparkcore(2, (void *)lock_acquire(testlock), testlock);
        unparkcore(3, (void *)lock_acquire(testlock), testlock);
